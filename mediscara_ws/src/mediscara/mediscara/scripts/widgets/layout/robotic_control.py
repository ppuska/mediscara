...
# Form implementation generated from reading ui file 'c:\Users\gyurc\OneDrive\Dokumentumok\VSCode Projects\mediscara\mediscara_ws\src\mediscara\mediscara\scripts\widgets\layout\robotic_control.ui'
#
...
class Ui_RoboticControlWidget(object):
    def setupUi(self, RoboticControlWidget):
        ...
        self.label_manager_message = QtWidgets.QLabel(RoboticControlWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_manager_message.sizePolicy().hasHeightForWidth())
        self.label_manager_message.setSizePolicy(sizePolicy)
        self.label_manager_message.setObjectName("label_manager_message")
        self.gridLayout.addWidget(self.label_manager_message, 3, 0, 1, 3)
    ...
    def retranslateUi(self, RoboticControlWidget):
        ...
        self.label_manager_message.setText(_translate("RoboticControlWidget", "TextLabel"))
