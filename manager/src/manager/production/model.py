...
class IndustialOrder(ProductionOrder):
    ...
    def from_ngsi(cls, entity: dict):
        ...
        try:
            ...
            logging.warning("Errors in incoming JSON object: %s", str(entity))
...
class Container:
    ...
    def from_ngsi(cls, entity: dict):
        ...
        try:
            ...
            logging.warning("Unable to create entity, errors were found in the incoming JSON object")
            raise KeyError from error
        ...
        for item in order_list:
            ...
            try:
                ...
                logging.warning("Errors found in incoming JSON object: %s", str(item))
                raise KeyError from error
