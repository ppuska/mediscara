...
bool interfaces__msg__kpic1__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._kpic1.KPIC1", full_classname_dest, 27) == 0);
  }
  interfaces__msg__KPIC1 * ros_message = _ros_message;
  {  // availability
...
{
  /* NOTE(esteve): Call constructor of KPIC1 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._kpic1");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "KPIC1");
