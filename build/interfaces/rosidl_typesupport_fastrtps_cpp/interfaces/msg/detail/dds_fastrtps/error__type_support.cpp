...
#include "interfaces/msg/detail/error__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::Error & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::Error & ros_message)
{
  // Member: node_name
  cdr >> ros_message.node_name;
...
{
  auto typed_message =
    static_cast<const interfaces::msg::Error *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::Error *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_Error__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, Error)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_Error__handle;
}
