...
#include "interfaces/msg/detail/error__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // error_msg, node_name
#include "rosidl_runtime_c/string_functions.h"  // error_msg, node_name

// forward declare type support functions


using _Error__ros_msg_type = interfaces__msg__Error;
...
size_t get_serialized_size_interfaces__msg__Error(
  const void * untyped_ros_message,
...
static uint32_t _Error__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__msg__Error(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__msg__Error(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_interfaces__msg__Error(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, msg, Error)() {
